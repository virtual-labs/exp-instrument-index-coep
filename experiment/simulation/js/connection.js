$("#spray").click(function ()  {
    ...
    <div class="row">
        ...
        <div class="col-2" style="border:2px solid black;">
            ...
            <div class="col-sm-12">
		     <button type="button" class="btn btn-primary"  id="btnNext" style="margin-top:30px;width:100%" disabled >Next Level</button>
		    </div>  
        </div>
...
//   $("#next").prop("hidden", false);
	...
	// Draw tank
	  ...
	  var afterHeating = paper.path("M"+(x+227)+" "+(y+110)+" l 0 -78 l 176 0 l 0 57	"+"M"+(x+489)+" "+(y+32)+" l 60 0 l 0 -50 l -61 0"+"M"+(x+550)+" "+(y+8.1)+"l 60 0").attr({"stroke-width":2}).toFront();	
		...
		var feedTankLabel = paper.text((x-25),(y+10),"Feed Tank").attr({"font-size": 14,"font-family": "Arial","font-weight": "bold", 
	 "fill": "#4d4949","text-anchor": "middle"}).toFront();
	 
	   var pumpLabel = paper.text((x+108),(y+125),"Pump").attr({"font-size": 14,"font-family": "Arial","font-weight": "bold", 
	 "fill": "#4d4949","text-anchor": "middle"}).toFront();
	 
	    var heaterLabel = paper.text((x+280),(y+140),"Heater").attr({"font-size": 14,"font-family": "Arial","font-weight": "bold", 
	 "fill": "#4d4949","text-anchor": "middle"}).toFront();
	 
	   var heaterLabel1 = paper.text((x+280),(y+157),"with SCR").attr({"font-size": 14,"font-family": "Arial","font-weight": "bold", 
	 "fill": "#4d4949","text-anchor": "middle"}).toFront();
	 
	   var fdLabel = paper.text((x+108),(y+286),"FD Fan").attr({"font-size": 14,"font-family": "Arial","font-weight": "bold", 
	 "fill": "#4d4949","text-anchor": "middle"}).toFront();
	   
	   
	   var IdLabel = paper.text((x+850),(y+168),"ID Fan").attr({"font-size": 14,"font-family": "Arial","font-weight": "bold", 
	 "fill": "#4d4949","text-anchor": "middle"}).toFront();
	 
	    var chimneyLabel = paper.text((x+910),(y-5),"Chimney").attr({"font-size": 14,"font-family": "Arial","font-weight": "bold", 
	 "fill": "#4d4949","text-anchor": "middle"}).toFront();
	   
		
		var compressorLabel = paper.text((x+630),(y+20),"From Compressor").attr({"font-size": 14,"font-family": "Arial","font-weight": "bold", 
	 "fill": "#4d4949","text-anchor": "middle"}).toFront();
...
//        });
    ...
    let pathElement3 = paper.path(`M${path.x} ${path.y} l ${lineLength} 0`).attr({
        stroke: "#cccfcd",
        "stroke-width": 2,
        "stroke-dasharray": path.dashed ? "-" : "",opacity:0.7
    });
});
